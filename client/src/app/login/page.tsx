    ...
    <div className="fixed inset-0 bg-[#f0f2f5] flex items-center justify-center z-[100] px-4 font-sans">
      <div className="max-w-[980px] w-full flex flex-col md:flex-row items-center justify-between gap-10 pb-20">
        ...
        <div className="flex-1 text-center md:text-left mb-8 md:mb-0 md:pr-8">
          <h1 className="text-5xl md:text-[60px] font-bold text-[#1877f2] mb-4 tracking-tight -ml-2">mini-facebook</h1>
          <p className="text-2xl md:text-[28px] text-[#1c1e21] leading-[32px] font-normal w-full md:w-[500px]">
            A safe space for students (6-14 years) to discover educational videos and learn together.
          </p>
        </div>
