...
import { LayoutDashboard, Users, FileText, Settings, Menu, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-gray-200">
        <Link href="/" className={`flex items-center gap-3 px-3 py-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200 hover:-translate-y-0.5 ${!isOpen && 'justify-center'}`}>
