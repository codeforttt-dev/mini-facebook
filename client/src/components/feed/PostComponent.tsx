...
export default function PostComponent({ post: initialPost, currentUser }: PostProps) {
  ...
  return (
    <div className="bg-white rounded-[8px] shadow-[0_1px_2px_rgba(0,0,0,0.2)] p-4 w-full mb-4">
      ...
      {/* Stats */}
      <div className="flex justify-between text-[#65676B] text-[15px] pb-3 border-b border-gray-200 mb-1">
